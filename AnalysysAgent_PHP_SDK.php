...
define('ANALYSYSAGENT_SDK_VERSION', '4.0.10');
...
class AnalysysAgent {
    ...
    private function profile($distinctId, $isLogin, $eventName, $properties, $platform,$type=null){
    ...
    public function profileSet($distinctId = null, $isLogin = false, $properties = array(), $platform = ANALYSYSAGENT_SDK_LIB) {
        $this->profile($distinctId, $isLogin, '$profile_set', $properties, $platform);
    }
    public function profileSetOnce($distinctId = null, $isLogin = false, $properties = array(), $platform = ANALYSYSAGENT_SDK_LIB) {
        $this->profile($distinctId, $isLogin, '$profile_set_once', $properties, $platform);
    }
    public function profileIncrement($distinctId = null, $isLogin = false, $properties = array(), $platform = ANALYSYSAGENT_SDK_LIB) {
        $this->profile($distinctId, $isLogin, '$profile_increment', $properties, $platform,'NUMBER');
    }
    public function profileAppend($distinctId = null, $isLogin = false, $properties = array(), $platform = ANALYSYSAGENT_SDK_LIB) {
        $this->profile($distinctId, $isLogin, '$profile_append', $properties, $platform);
    }
    public function profileUnset($distinctId = null, $isLogin = false, $key = null, $platform = ANALYSYSAGENT_SDK_LIB) {
        if (is_null($distinctId) || strlen($distinctId) == 0) {
            throw new AnalysysAgentException("aliasId is empty.");
        }
        ...
        $this->upload($distinctId, $isLogin, '$profile_unset', $properties, $platform);
    }
    public function profileDelete($distinctId = null, $isLogin = false, $platform = ANALYSYSAGENT_SDK_LIB) {
        $properties=array();
        $this->upload($distinctId, $isLogin, '$profile_delete', $properties, $platform);
    }

    public function alias($aliasId, $original_id, $platform){
        ...
        $this->upload($aliasId, true, '$alias', $properties, $platform);
    }
    public function track($distinctId = null, $isLogin = false,$eventName=null, $properties = array(), $platform = ANALYSYSAGENT_SDK_LIB) {
        if (is_null($distinctId) || strlen($distinctId) == 0) {
            throw new AnalysysAgentException("aliasId is empty.");
        }
        if (!is_bool($isLogin)) {
